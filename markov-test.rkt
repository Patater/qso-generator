...
(let ([corpus '(My name is Andrey Markov and this is my chain.)])
  ...
  (check-equal? (generate-markov-chain 3 corpus)
                (make-hash '(((My name is) . (Andrey))
                             ((name is Andrey) . (Markov))
                             ((is Andrey Markov) . (and))
                             ((Andrey Markov and) . (this))
                             ((Markov and this) . (is))
                             ((and this is) . (my))
                             ((this is my) . (chain.))))))
(let ([corpus '(My donkey is a donkey is a donkey is a donkey is your chain.)])
  (check-equal? (generate-markov-chain 2 corpus)
                (make-hash '(((My donkey) . (is))
                             ((donkey is) . (a a a your))
                             ((is a) . (donkey donkey donkey))
                             ((is your) . (chain.))
                             ((a donkey) . (is is is)))))
  (check-equal? (generate-markov-chain 3 corpus)
                (make-hash '(((My donkey is) . (a))
                             ((donkey is a) . (donkey donkey donkey))
                             ((is a donkey) . (is is is))
                             ((a donkey is) . (a a your))
                             ((donkey is your) . (chain.))))))
